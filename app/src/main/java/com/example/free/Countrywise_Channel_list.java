...
public class Countrywise_Channel_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_countrywise_channel_list);
        searchdata = findViewById(R.id.txt_search_country);
        listView = findViewById(R.id.listViewChannel);
        ...
        page_name = bundle.getString("country_name");
        ...
        recordData.put("select","");
        recordData.put("id", channel_id);
        CountryChanneldatafromAPIRequest request = new CountryChanneldatafromAPIRequest(Api.URL_READ_COUNTRY_WISE_CHANNEL, recordData, Api.CODE_POST_REQUEST);
        request.execute();
        //call adapter class for bind data
    ...
    private class CountryChanneldatafromAPIRequest  extends AsyncTask<Void, Void, String> {
        String url;
        HashMap<String, String> params;
        int requestCode;

        CountryChanneldatafromAPIRequest(String url, HashMap<String, String> params, int requestCode) {
            this.url = url;
            this.params = params;
