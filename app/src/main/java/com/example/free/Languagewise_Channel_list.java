...
public class Languagewise_Channel_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_languagewise__channel_list);
        searchdata = findViewById(R.id.txt_search_language);
        listView = findViewById(R.id.languagewise_listViewChannel);
        ...
        page_name = bundle.getString("language_name");
        ...
        recordData.put("select_language","");
        recordData.put("id", channel_id);
        LanguageChanneldatafromAPIRequest request = new LanguageChanneldatafromAPIRequest(Api.URL_READ_LANGUAGE_WISE_CHANNEL, recordData, Api.CODE_POST_REQUEST);
        request.execute();
        //call adapter class for bind data
    ...
    private class LanguageChanneldatafromAPIRequest  extends AsyncTask<Void, Void, String> {
        String url;
        HashMap<String, String> params;
        int requestCode;

        LanguageChanneldatafromAPIRequest(String url, HashMap<String, String> params, int requestCode) {
            this.url = url;
            this.params = params;
